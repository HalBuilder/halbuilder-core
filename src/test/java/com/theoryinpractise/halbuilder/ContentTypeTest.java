...
public class ContentTypeTest {
  ...
  public void testContentTypeCreation() {
    ...
    assertThat(new ContentType("{application/hal+json, q=1000}").getType())
        .isEqualTo("application");
    assertThat(new ContentType("{application/hal+json, q=1000}").getSubType())
        .isEqualTo("hal+json");
  ...
  public void testContentTypeMatching() {
    assertThat(new ContentType("application/xml").matches(new ContentType("application/xml")))
        .isTrue();
    assertThat(new ContentType("application/xml").matches(new ContentType("application/*")))
        .isTrue();
    ...
    assertThat(
            new ContentType("application/json")
                .matches(new ContentType("{application/json; q=1000}")))
        .isTrue();
    assertThat(
            new ContentType("application/json")
                .matches(new ContentType("{application/json;q=1000}")))
    ...
    assertThat(
            new ContentType("application/hal+json")
                .matches(new ContentType("{application/hal+json; q=1000}")))
        .isTrue();
    assertThat(
            new ContentType("application/hal+json")
                .matches(new ContentType("{application/hal+json;q=1000}")))
    ...
    assertThat(
            new ContentType("application/hal+json")
                .matches(new ContentType("{*/hal+json ,q=1000}")))
        .isTrue();
    assertThat(new ContentType("*/*").matches(new ContentType("{application/hal+json ,q=1000}")))
        .isFalse();
  }
}
